...
If not created, create a symbolic link to the binaries (*bin*) and the *lib* directory of the Besu version you are interested in.
...
Once the *besu.services* file has been saved, needs to be started. The following commands will be executed.
